var e, n, t, r, i, a = -1,
        ...
        var t, r = [1800, 3e3],
            ...
            c = function(e) {
                e.forEach((function(e) {
                    "first-contentful-paint" === e.name && (p && p.disconnect(), e.startTime < i.firstHiddenTime && (a.value = Math.max(e.startTime - u(), 0), a.entries.push(e), t(!0)))
                }))
            },
            d = window.performance && window.performance.getEntriesByName && window.performance.getEntriesByName("first-contentful-paint")[0],
            p = d ? null : s("paint", c);
        (d || p) && (t = l(e, a, r, n.reportAllChanges), d && c([d]), o((function(i) {
            ...
            p = function(e) {
                e.forEach((function(e) {
                    if (!e.hadRecentInput) {
                        var n = u[0],
                            t = u[u.length - 1];
                        c && e.startTime - t.startTime < 1e3 && e.startTime - n.startTime < 5e3 ? (c += e.value, u.push(e)) : (c = e.value, u = [e]), c > a.value && (a.value = c, a.entries = u, r())
                    }
                }))
            },
            v = s("layout-shift", p);
    ...
    k = function(e) {
        e.forEach((function(e) {
            e.interactionId && (P = Math.min(P, e.interactionId), M = Math.max(M, e.interactionId), I = M ? (M - P) / 7 + 1 : 0)
        }))
    },
    B = function() {
    ...
    D = function() {
        "interactionCount" in performance || i || (i = s("event", k, {
            type: "event",
            buffered: !0,
            durationThreshold: 0
        }))
    ...
    O = function(e, n) {
        ...
        var r, i = f("INP"),
            a = function(e) {
                e.forEach((function(e) {
                    (e.interactionId && H(e), "first-input" === e.entryType) && (!R.some((function(n) {
                        return n.entries.some((function(n) {
                            return e.duration === n.duration && e.startTime === n.startTime
                        }))
                    })) && H(e))
                }));
                var n, t = (n = Math.min(R.length - 1, Math.floor(N() / 50)), R[n]);
        ...
        r = l(e, i, t, n.reportAllChanges), c && (c.observe({
            ...
            a(c.takeRecords()), i.value < 0 && N() > 0 && (i.value = 0, i.entries = []), r(!0)
        })), o((function() {
            R = [], x = B(), i = f("INP"), r = l(e, i, t, n.reportAllChanges)
        })))
    },
    j = {},
    _ = function(e, n) {
...
export {
    E as getCLS, g as getFCP, F as getFID, O as getINP, _ as getLCP, G as getTTFB, E as onCLS, g as onFCP, F as onFID, O as onINP, _ as onLCP, G as onTTFB
};